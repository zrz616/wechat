<?php if ($_GET['json'] && ($_GET['token'] == "doubleq"))  {//可以改token,这相当于密码，在Arduino端改成相应的值即可
    $con = mysql_connect(SAE_MYSQL_HOST_M.':'.SAE_MYSQL_PORT,SAE_MYSQL_USER,SAE_MYSQL_PASS); 
		$json = $_GET['json'];
    mysql_select_db("app_wechatfurnishing", $con);//要改成相应的数据库名
...
$sql ="UPDATE sensor SET timestamp='$dati',data = '$temperature',humi = '$humi'
